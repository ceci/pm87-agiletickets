...
public class Sessao {
	...
	public boolean podeReservar(Integer ingressosRequisitados) {
        return getIngressosDisponiveis() >= ingressosRequisitados;
	}
	...
	public double porcentagemDeIngressosDisponiveis() {
